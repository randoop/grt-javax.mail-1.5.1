...
public class MimeMessage extends Message implements MimePart {
     ...
     * @see		#headers
     * @see		javax1.mail.Message.RecipientType#TO
     * @see		javax1.mail.Message.RecipientType#CC
     * @see		javax1.mail.Message.RecipientType#BCC
     * @see		javax1.mail.internet.MimeMessage.RecipientType#NEWSGROUPS
     */
     ...
     * @see        javax1.mail.search.MessageIDTerm
     * @since 	   JavaMail 1.1
     */
     ...
     * {@link javax1.mail.Flags.Flag#ANSWERED ANSWERED} flag is set
     * in this message. <p>
     *
     * The "Subject" field is filled in with the original subject
     * prefixed with "Re:" (unless it already starts with "Re:").
     ...
     *
     * @exception javax1.mail.MessagingException
     * @exception IOException	if an error occurs writing to the stream
     *				or if an error is generated by the
     *				javax.activation layer.
     * @see javax.activation.DataHandler#writeTo
